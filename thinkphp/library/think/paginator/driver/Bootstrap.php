...
class Bootstrap extends Paginator
{
    ...
    public function render()
    {
        if ($this->hasPages()) {
            if ($this->simple) {
                return sprintf(
                    '<nav aria-label="Page navigation example"><ul class="pager justify-content-center">%s %s</ul></nav>',
                    $this->getPreviousButton(),
                    $this->getNextButton()
                );
            } else {
                return sprintf(
                    '<nav aria-label="Page navigation example"><ul class="pagination justify-content-center">%s %s %s</ul></nav>',
                    $this->getPreviousButton(),
                    $this->getLinks(),
                    $this->getNextButton()
                );
